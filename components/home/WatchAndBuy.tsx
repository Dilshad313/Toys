...
import { Play, Pause, Volume2, VolumeX, Maximize, ChevronLeft, ChevronRight, ShoppingCart } from 'lucide-react'
      ...
      <div key={product.id} className="flex-shrink-0 w-[280px] md:w-[320px] snap-start">
        <div className="bg-white rounded-xl shadow-md hover:shadow-lg transition overflow-hidden border border-gray-100">
          ...
          <div className="p-3">
            ...
            <p className="text-gray-500 text-xs mt-0.5">Watch it in action</p>

            <button
              onClick={() => handleAddToCart(product)}
              disabled={isAdding}
              className="w-full mt-2 py-2 rounded-lg bg-[#D32F2F] hover:bg-[#B71C1C] text-white text-sm font-semibold transition flex items-center justify-center gap-2 disabled:opacity-60 disabled:cursor-wait"
            >
              {isAdding ? (
                <>
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="relative">
          ...
          >
            {isLoadingProducts ? (
              [1, 2, 3].map((item) => (
                <div key={item} className="flex-shrink-0 w-[280px] md:w-[320px] snap-start">
                  <div className="bg-white rounded-xl shadow-md overflow-hidden border border-gray-100">
                    <div className="bg-black/10 aspect-video animate-pulse" />
